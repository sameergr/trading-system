package com.dhan.collector.controller;

import com.dhan.collector.repository.BackfillProgressRepository;
import com.dhan.collector.repository.CandleRepository;
import com.dhan.collector.service.BackfillService;
import com.dhan.collector.service.DerivedCandleService;
...
public class BackfillController {
    ...
    public ResponseEntity<?> getProgress(@RequestParam long instrumentId) {
        var intervals = List.of("1m", "5m", "15m", "60m", "1d", "1W", "1M");
